...
public class Simulator {
    ...
    private final List<Animal> startingAnimals = new ArrayList<>();
    ...
    public Simulator(int depth, int width, int... seed) {
        ...
        reset();
        this.startingField = new Field (field);
        startingAnimals.addAll(animals);
    }
    ...
    public void reset() {
        step = 0;
        animals.clear();
        if (startingAnimals.size() == 0) {
            populate();
        }else {
            animals.addAll(startingAnimals);
        }
        if(startingField != null){
            field = new Field(startingField);
        }
